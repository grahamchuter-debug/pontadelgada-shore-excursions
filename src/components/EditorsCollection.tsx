    ...
    <section className="section-padding bg-coastal-50">
      <div className="container-wide">
        ...
        <p className="section-subtitle">
          Not every passenger wants the same São Miguel. Our editorial team recommends the strongest
          option for each traveller type — honest picks, not catalogue listings.
        </p>
