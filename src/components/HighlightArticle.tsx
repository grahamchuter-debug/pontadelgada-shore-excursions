...
export function HighlightArticle({ page }: { page: AttractionPage }) {
  ...
  return (
    <>
      ...
      />
      <PhotoHeroBand image={image} eyebrow="From Ponta Delgada Cruise Port" title={page.title} subtitle={page.tagline} compact />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          {(page.slug === "sete-cidades-from-ponta-delgada" || page.slug === "ponta-delgada-historic-centre-guide") && (
            <SignatureExperienceCallout
              context={page.slug === "sete-cidades-from-ponta-delgada" ? "sete-cidades" : "ponta-delgada"}
            />
          )}

          {related.length > 0 && (
            <div className="mt-12">
              <h2 className="section-title text-2xl mb-6">More São Miguel guides</h2>
          ...
          <div className="mt-12">
            <FAQSection faqs={page.faqs} title={`${page.attractionName} from Ponta Delgada — FAQs`} />
          </div>
          <div className="mt-12">
            <PlanningLinks />
          </div>
