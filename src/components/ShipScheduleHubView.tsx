  ...
  return (
    <>
      ...
      {!hasData && (
        <div className="mb-8 rounded-xl border border-amber-200 bg-amber-50 p-6">
          ...
          <p className="mt-2 text-sm text-amber-900">
            ...
            <Link href="/ponta-delgada-cruise-port" className="font-medium underline">
              cruise port guide
            </Link>{" "}
            for planning.
          </p>
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        <Link href="/ponta-delgada-cruise-port" className="btn-secondary text-sm">Cruise Port Guide</Link>
