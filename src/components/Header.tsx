...
const navItems = [
  ...
  { href: "/ponta-delgada-cruise-port", label: "Cruise Port Guide" },
  { href: "/ponta-delgada-cruise-ship-schedule", label: "Ship Schedule" },
  { href: "/things-to-do-in-ponta-delgada-from-a-cruise-ship", label: "Things to Do" },
  { href: "/faq", label: "FAQs" },
];
    ...
    <header className="sticky top-0 z-50 border-b border-coastal-100 bg-white/95 backdrop-blur-sm">
      <div className="container-wide flex items-center justify-between gap-3 px-4 py-3 sm:px-6 sm:py-3.5 lg:px-8">
        ...
        <div className="hidden xl:block shrink-0">
          <Link href="/shore-excursions#excursions" className="btn-accent text-sm">
            Explore Excursions
          </Link>
        </div>
        <button
      ...
      {open && (
        <nav className="xl:hidden border-t border-coastal-100 bg-white px-4 py-4" aria-label="Mobile navigation">
          <div className="flex flex-col gap-1">
            ...
            <Link
              href="/shore-excursions#excursions"
