...
/** TravelAgency for the Ponta Delgada and São Miguel cruise planning brand. */
export function travelAgencySchema() {
  return {
    ...
    areaServed: [
      {
        ...
        address: {
          ...
          addressRegion: "São Miguel, Azores",
          addressCountry: "PT",
        },
      },
    ],
    knowsAbout: [
      ...
      "Furnas Valley from Ponta Delgada",
      "São Miguel cruise excursions",
      "Ponta Delgada cruise planner",
    ],
    contactPoint: {
      "@type": "ContactPoint",
      email: SITE.email,
