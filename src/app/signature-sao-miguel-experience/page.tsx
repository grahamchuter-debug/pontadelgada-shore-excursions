...
import { signatureSaoMiguelExperience, SIGNATURE_EXPERIENCE_PATH } from "@/data/signature-experience";
import { subjectImages } from "@/lib/images";
import { ResponsiveImage } from "@/components/ResponsiveImage";
import { PreloadImage } from "@/components/PreloadImage";

const path = SIGNATURE_EXPERIENCE_PATH;
const image = subjectImages["sete-cidades"];

export const metadata = buildMetadata({
  title: signatureSaoMiguelExperience.seoTitle,
  description: signatureSaoMiguelExperience.metaDescription,
  path,
  image: image.src,
  imageAlt: "Sete Cidades and São Miguel scenery — future Signature Experience from Ponta Delgada cruise port",
  keywords: [
    "Signature São Miguel Discovery",
    "Ponta Delgada shore excursions",
    "small group Sete Cidades tour",
    "São Miguel cruise excursions",
  ],
});

const breadcrumbs = [
  { name: "Home", path: "/" },
  { name: "Signature São Miguel Discovery", path },
];

export default function SignatureSaoMiguelExperiencePage() {
  return (
    <>
      <JsonLd
        data={[
          breadcrumbSchema(breadcrumbs),
          faqSchema(signatureSaoMiguelExperience.faqs),
          articleSchema({
            title: signatureSaoMiguelExperience.seoTitle,
            description: signatureSaoMiguelExperience.metaDescription,
            path,
      ...
      <section className="section-signature-hero">
        ...
        <div className="container-wide relative z-10 px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <h1 className="home-hero-heading mt-6 max-w-3xl">{signatureSaoMiguelExperience.title}</h1>
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-white/90">
            {signatureSaoMiguelExperience.tagline}
          </p>
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-white/75">
            {signatureSaoMiguelExperience.overview}
          </p>
        ...
        <div className="container-wide max-w-4xl">
          ...
          <div className="placeholder-widget mt-8">
            ...
            <p className="mt-3 text-gray-700 leading-relaxed">
              ...
              guests, cruise-timed routing and a carefully paced Sete Cidades day. It is a concept in
              preparation, not a currently bookable excursion.
            </p>
          </div>

          <div className="mt-10 grid gap-3 sm:grid-cols-2">
            {signatureSaoMiguelExperience.benefits.map((b) => (
          ...
          <div className="mt-12">
            <FAQSection faqs={signatureSaoMiguelExperience.faqs} title="Signature São Miguel Discovery — FAQs" />
          </div>

          <div className="mt-10 flex flex-wrap gap-3">
            <Link href="/compare/best-sao-miguel-shore-excursion" className="btn-secondary">
