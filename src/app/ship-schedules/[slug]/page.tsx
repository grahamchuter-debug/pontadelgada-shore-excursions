...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!port) return {};
  // Legacy alias — canonical page for Ponta Delgada is /ponta-delgada-cruise-ship-schedule.
  return buildMetadata({
    title: port.seoTitle,
    description: port.metaDescription,
    path: slug === "ponta-delgada" ? "/ponta-delgada-cruise-ship-schedule" : portHubPath(slug),
    noindex: slug === "ponta-delgada",
  });
}
