      ...
      <section className="section-padding">
        <div className="container-wide max-w-3xl">
          ...
          <div className="mt-6 space-y-4 text-gray-700 leading-relaxed">
            <p>{SITE.name} ({SITE.url}) is an independent Ponta Delgada and São Miguel cruise planning resource. This policy explains what information we collect and how we use it.</p>
