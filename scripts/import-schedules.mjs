#!/usr/bin/env node
/**
 * Import Ponta Delgada cruise ship schedules from CSV into the site's JSON data file.
 *
 * Usage:  node scripts/import-schedules.mjs
 *
 * Source:  data/schedule-sources/ponta-delgada.csv
 * Output:  src/data/imported-schedules/ponta-delgada.json
 */
...
const SOURCE = resolve(ROOT, "data/schedule-sources/ponta-delgada.csv");
const OUTPUT = resolve(ROOT, "src/data/imported-schedules/ponta-delgada.json");
